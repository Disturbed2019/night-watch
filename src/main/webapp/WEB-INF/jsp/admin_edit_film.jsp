    ...
    <main class="main admin">
        <div class="container">
            ...
            <div class="add">
                ...
                <form method="post" action="/admin/edit-film/${film.id}" enctype="multipart/form-data">
                    <hidden path="id"/>
                    ...
                    <div class="form__control">
                        <input name="title" type="text" id="title" path="title" value="${film.title}"/>
                        <label for="title" path="title">Название</label>
                    </div>
                    <div class="form__control">
                        <input name="description" type="text" id="description" path="description" value="${film.description}"/>
                        <label for="description" path="description">Описание</label>
                    </div>
                    <div class="form__control">
                        <input name="preview" type="file" id="preview_img" path="previewImg" value="${film.previewImg}"/>
                        <label for="preview_img" path="previewImg">Постер</label>
                    </div>
                    <div class="form__control">
                        <input name="year" type="text" id="year" path="year" value="${film.year}"/>
                        <label for="year" path="year">Год</label>
                    </div>
                    <div class="form__control">
                        <input name="rating" type="text" id="rating" path="rating" value="${film.rating}"/>
                        <label for="rating" path="rating">Рейтинг</label>
                    </div>
                    <div class="form__control">
                        <input name="bg_img" type="file" id="bg_img" path="bg_img" value="${film.bgImg}"/>
                        <label for="bg_img" path="bg_img">Картинка для бэкграунда</label>
                    </div>
                    <div class="form__control">
                        <input name="trailerLink" type="text" id="trailer_link" path="trailerLink" value="${film.trailerLink}"/>
