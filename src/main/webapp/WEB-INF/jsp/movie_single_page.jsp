...
<body>
<div class="wrapper single__wrapper" style="background-image: url('../../images/backgrounds/it_bg.jpg')">
    <header class="header">
        <div class="container">
            ...
            <div class="container">
                <div class="single__inner">
                    <div class="single__content">
                        <h1 class="single__title">IT</h1>
                        <div class="single__badge">
                            <span class="single__badge-year">2017</span>
                        ...
                        <p class="single__description">Злобный клоун терроризирует подростков. Экранизация романа Стивена Кинга с жутким Биллом Скарсгардом</p>
                        <div class="single__buttons">
                            <a class="button single__buttons-watch" data-fancybox href="https://www.youtube.com/watch?v=IisU-JHj_fU">
